...
public:
  ...
  void printText(const char *text, const ScreenPoint p = {0, 0}, const FontSize textSize = FONT_SIZE_1,
                 const Colour colour = COLOUR_DEFAULT, const displayOption_t options = 0);
