...
class LayoutPedals : public LayoutInterface {
	...
	private:
		...
		byte indexForEffectId(const EffectId effectId) {
			switch (effectId) {
				case ID_FUZZ1: 		return Drive1;
				case ID_FUZZ2:		return Drive2;
				case ID_DELAY1: 	return Delay1;
				case ID_DELAY2:		return Delay2;
				case ID_WAH1:			return Wah1;
				case ID_CHORUS1:	return Mod1;
				default: 					return 0; //to stop compiler warnings
			}
		}
